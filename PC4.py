...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center; '>Un poco de mi Mundo 🌍", unsafe_allow_html=True)
    ...
    col1.image("IMG_1877.JPG", caption='Alejandro Vasquez', width=300)
    ...
    texto = """
    Me llamo Alejandro, tengo 19 años y nací en Lima. 
    Soy un joven apasionado por los videojuegos y las películas. 
    En mis tiempos libres me gusta jugar futbol y mi equipo favorito es el Real Madrid. 
    Tengo 2 hermanos y vivo en el Callao. Estudié en el colegio “Chaperito Schools” 
    y actualmente estudio Ciencias de la comunicación en la universidad Pontificia Univerdad Católica del Perú. 
    """
    ...
    texto_2 = """
    Mi experiencia como principiante y primera vez usando phyton a través de google collab, 
    ha sido muy divertido e interesante, ya que ha sido un nuevo aprendizaje y una experiencia única, 
    al adentrarme al mundo de la programación. Al principio fue complicado porque no estaba acostumbrado, 
    pero con el pasar de las clases fui adaptándome y aprendiendo cada vez más, convirtiéndose así en una experiencia inolvidable. 
    """
    ...
    st.markdown("<h2 style='text-align: center;'>Mi intento de programación en la serpiente 🐍🎥</h2>", unsafe_allow_html=True)
    ...
    st.markdown(f"<div style='text-align: center;'><a href='https://drive.google.com/file/d/1Rqw_qqxv1mCeA-GEXOu_XyTJ-iq8R_wz/view?usp=sharing' target='_blank'><button>Ver video</button></a></div>", unsafe_allow_html=True) 
    ...
    st.markdown("<h1 style='text-align: center;'>Gráficos sobre mis trabajos en Phyton</h1>", unsafe_allow_html=True)

    # Creamos una lista de gráficos
    graficos = ['Gráfico de torta - Distribución de Pelis', 'Gráfico de barras - Películas y series por año de estreno', 'Mapa_Ubicación_Pelis']
    ...
    if grafico_seleccionado == 'Gráfico de torta - Distribución de Pelis':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>El gráfico muestra que la mayoría del contenido en la plataforma son películas (69.6%), lo que nos muestra la preferencia en ofrecer títulos de este estilo, mientras que las series (30.4%) son menos pero podrían tener un mayor impacto en la retención de usuarios.</div>", unsafe_allow_html=True)
        st.image("Grafico2.png", caption='Gráfico de torta - Distribución de Pelis', width=700)
        pass
    elif grafico_seleccionado == 'Gráfico de barras - Películas y series por año de estreno':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>El gráfico muestra que la cantidad de películas y series estrenadas aumentó de forma progresiva desde el año 2000, con un pico entre 2017 y 2019. Este crecimiento acelerado en las producciones audiovisuales, se puede deber por el auge y nacimiento de las plataformas de streaming..</div>", unsafe_allow_html=True)
        st.image("Grafico1.png", caption='Gráfico de barras - Películas y series por año de estreno', width=700)
        pass
    elif grafico_seleccionado == 'Mapa_Ubicación_Pelis':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>En este mapa podremos observar, las distintas ubicaciones en las que fueron grabadas las películas y series de los gráficos anteriores</div>", unsafe_allow_html=True)
